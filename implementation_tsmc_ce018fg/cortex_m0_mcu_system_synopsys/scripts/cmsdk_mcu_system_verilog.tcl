...
# Behaviour clock gating in cm0_acg.v and cm0_pmu_acg.v are replaced by cm0_acg_tsmc180.v
# and cm0_pmu_acg_tsmc180.v with the library clock gating cell
set cortexm0_cells [ list \
            cm0_acg_tsmc180.v \
...
# Behaviour clock gating in cm0p_acg.v and cm0p_ik_pmu_acg.v are replaced by cm0p_acg_tsmc180.v
# and cm0p_pmu_acg_tsmc180.v with the library clock gating cell
set cm0p_cells [ list \
                   cm0p_acg_tsmc180.v \
